...
@Composable
fun RegistroClienteScreen(onRegistered: () -> Unit) {
    ...
    Scaffold(topBar = { TopAppBar(title = { Text("Registro - Cliente") }) }) { padding ->
                ...
                auth.createUserWithEmailAndPassword(email, password)
                    .addOnSuccessListener { authResult ->
                        scope.launch {
                            ...
                            val usuario = Usuario(uid = uid, nombre = nombre, email = email, rol = "cliente")
